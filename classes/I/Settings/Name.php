...
enum Name: string
{
    ...
    case MD_RECORD_AUSBILDUNG = 'Sifa-Ausbildung';
    case MD_RECORD_ABSCHNITT = 'Sifa-Abschnitt';
    case UDF_SUPERVISOR = 'supervisor';
    case UDF_SUPERVISOR_EMAIL = 'supervisor_mail';
    case UDF_MEMBER_ID = 'member_id';
    case UDF_TUTOR_ID = 'tutor_id';
    case UDF_COMPANION_ID = 'companion_id';
    case UDF_SUPERVISOR_ID = 'supervisor_id';
}
